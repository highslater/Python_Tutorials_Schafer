...
"""001_Python_Install_and_Setup.py.

First Program of the Corey Schafer Python Series.
...
logging.basicConfig(filename="LOG_files/LOG_001.Log",
...
logger.info("001_Python_Install_and_Setup.py RUN / START")
